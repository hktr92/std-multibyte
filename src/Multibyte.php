...
namespace Std\Multibyte;

use Std\Ext\ExtensionUtil;
...
/**
 * Class Multibyte
 * @package Std\Multibyte
 * @since   1.0.0
 */
final class Multibyte {
    private const EXTENSION = 'mbstring';
    ...
    public static function isSupported(): bool {
        return ExtensionUtil::isLoaded(self::EXTENSION);
    }

    /**
     * Sets the internal PHP encoding. Defaults to UTF-8.
     *
    ...
    /** Generated from {@see \mb_list_encodings} */
    public const
        PASS = 'pass',
        WCHAR = 'wchar',
        BYTE2BE = 'byte2be',
